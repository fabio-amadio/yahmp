...
register_mjlab_task(
  task_id="Mjlab-YAHMP-NonResidual-Unitree-G1",
  env_cfg=unitree_g1_yahmp_non_residual_env_cfg(),
  play_env_cfg=unitree_g1_yahmp_non_residual_env_cfg(play=True),
  rl_cfg=unitree_g1_yahmp_non_residual_ppo_runner_cfg(),
  runner_cls=YahmpOnPolicyRunner,
)
