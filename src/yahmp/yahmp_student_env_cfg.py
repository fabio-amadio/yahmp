...
def _student_motion_command_kwargs() -> dict[str, object]:
  """Return shared kwargs for the student motion command."""
  return dict(_motion_command_kwargs())


def _teacher_actor_observation_group() -> ObservationGroupCfg:
...
def make_student_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  cfg.observations["teacher_actor"] = _teacher_actor_observation_group()
